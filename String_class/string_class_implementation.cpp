...
class String{
	public:
		...
		String(const char q[]);	//second constructor       IMPORTANT:::: the const modifier is a must, without it on VS, the program won't run. Running from the command line using g++ produces warnings
		// big 3
